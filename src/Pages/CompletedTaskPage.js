...
function CompletedTaskPage() {
    ...
    const completedTasks = items.filter(task => task.status === 'Completed');
        ...
        <div className='text-2xl font-semibold mt-20 ms-20'>
            <div className='text-start'>
                ...
                <div className='flex items-center gap-1 mt-4 text-gray-600'>
                    ...
                    <span className='text-sm font-normal'>{completedTasks.length} Tasks</span>
                </div>
            </div>
            ...
            <div className='mt-10 flex gap-4 justify-start items-center flex-wrap'>
                {
                    completedTasks.length > 0 ? completedTasks.map((task, index) => (
                        ...
                        <div className='text-gray-500'>No completed tasks available</div>
                    )
                }
